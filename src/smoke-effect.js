...
var MAIN_COLOR = [ 254/255, 235/255, 166/255 ];
...
function pointerPrototype() {
    ...
    this.moved = false;
    // this.color = [ 30, 0, 300 ];
    this.color = [ 254/255, 235/255, 166/255 ];
}
...
function update() {
    ...
    if ( splatStack.length > 0 ) {
        for ( var m = 0; m < splatStack.pop(); m++ ) {
            ...
            var color = [ 254/255, 235/255, 166/255 ];
